...
#ifndef LINKID_MMP_INTERNAL_SWIFT_H
#define LINKID_MMP_INTERNAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="linkid_mmp_internal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19linkid_mmp_internal23AirflexDeepLinkDelegate")
@interface AirflexDeepLinkDelegate : UIResponder <UIApplicationDelegate>
...
SWIFT_CLASS("_TtC19linkid_mmp_internal17DetectWindowTouch")
